...
export const FIELD_REGISTRY: Record<string, FieldDef> = {
  cameraMake: { key: "cameraMake", label: "Camera make", type: FieldType.string, storage: { kind: "column", column: "cameraMake" }, ops: STR_COL_OPS, aliases: ["make"] },
  cameraModel: { key: "cameraModel", label: "Camera", type: FieldType.string, storage: { kind: "column", column: "cameraModel" }, ops: STR_COL_OPS, aliases: ["camera", "model"] },
  lensModel: { key: "lensModel", label: "Lens", type: FieldType.string, storage: { kind: "column", column: "lensModel" }, ops: STR_COL_OPS, aliases: ["lens"] },
  ...
  orientation: { key: "orientation", label: "Orientation", type: FieldType.number, storage: { kind: "json", path: ["orientation"] }, ops: [RuleOp.eq, RuleOp.ne, RuleOp.gte, RuleOp.lt] },
